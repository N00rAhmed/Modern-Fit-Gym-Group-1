...
<body>
    <!-- <header>
        <nav>
            <img class="navbar-logo" src="<?php echo e(asset('Images/logo.png')); ?>" height="100px" width="100px" />
        ...
        <div id="mz-gallery">
            <div class="gallery">
                <a target="_blank" href="img_5terre.jpg">
                    <img src="<?php echo e(asset('../Images/Slide1.jpg' )); ?>" alt="Cinque Terre" width="600" height="400">
                </a>
                <div class="desc">
            ...
            <div class="gallery">
                        <a target="_blank" href="img_forest.jpg">
                            <img src="<?php echo e(asset('../Images/Slide2.jpg' )); ?>" alt="Forest" width="600" height="400">
                        </a>
                        <div class="desc">
            ...
            <div class="gallery">
                        <a target="_blank" href="img_lights.jpg">
                            <img src="<?php echo e(asset('../Images/Slide3.jpg' )); ?>" alt="Northern Lights" width="600" height="400">
                        </a>
                        <div class="desc">
            ...
            <div class="gallery">
                        <a target="_blank" href="img_mountains.jpg">
                            <img src="<?php echo e(asset('../Images/Slide4.jpg' )); ?>" alt="Mountains" width="600" height="400">
                        </a>
                        <div class="desc">
            ...
            <div class="gallery">
                ...
                <img src="<?php echo e(asset('../Images/Slide5.jpg' )); ?>" alt="Mountains" width="600" height="400">
                </a>
                <div class="desc">
...
<?php echo $__env->make('nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noora\OneDrive\Desktop\LARAVEL\Modern-Fit-Gym\Modern-Fit-Gym-Laravel\resources\views/welcome.blade.php ENDPATH**/ ?>